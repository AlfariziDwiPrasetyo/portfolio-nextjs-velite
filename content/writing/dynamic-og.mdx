...
you can test or create an og image here [https://og-playground.vercel.app/] if you want, remember if you using tailwind its not 100% support it, there are few classes that is not supported yet 
