...
you need to install the catpuccin-mocha theme for kitty first [here](https://github.com/catppuccin/kitty)

then type this command ``starship preset gruvbox-rainbow -o ~/.config/starship.toml`` to test the preset first

and copy [this](https://github.com/typecraft-dev/dotfiles/blob/master/starship/.config/starship.toml) config and paste it to your ``starship.toml`` file
